...
public:
    explicit PrintOpLowering(MLIRContext *context)
        : ConversionPattern(obs::PrintOp::getOperationName(), 1, context) { }
    ...
    matchAndRewrite(Operation *op, ArrayRef<Value> operands, 
        ...
        Value formatSpecifierCst = getOrCreateGlobalString(loc, rewriter, "frmt_spec", 
                        StringRef("%f \0", 4), parentModule);
        ...
        auto printOp = cast<obs::PrintOp>(op);
...
std::unique_ptr<mlir::Pass> mlir::obs::createLowerToLLVMPass() {
